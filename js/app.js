...
const NAV_GROUPS = [
  ...
  { id:'image', label:'Bild', roots:['camera','perspective','framing','composition','lighting','focus_depth_of_field','shot_style','mood','style_medium','effects','realism'] }
];
...
const TAXONOMY_LABELS = {
  ...
  body:['Body','Körper'], build:['Overall build','Gesamtstatur'], proportions:['Proportions','Proportionen'], height:['Height','Körpergröße'], shoulders:['Shoulders','Schultern'], torso:['Torso','Oberkörper'], hips:['Hips','Hüften'], pelvis:['Pelvis','Becken'], tissue_distribution:['Tissue distribution','Gewebeverteilung'], abdomen:['Abdomen','Bauch'], hips_thighs:['Hips & thighs','Hüften & Oberschenkel'], thighs:['Thighs','Oberschenkel'], secondary_sex_characteristics:['Secondary sex characteristics','Sekundäre Geschlechtsmerkmale'], breast:['Breast','Brust'], details:['Details','Details'],
  face:['Face','Gesicht'], shape:['Shape','Form'], forehead:['Forehead','Stirn'], cheeks:['Cheeks','Wangen'], jaw_chin:['Jaw & chin','Kiefer & Kinn'], eyes:['Eyes','Augen'], eyebrows:['Eyebrows','Augenbrauen'], nose:['Nose','Nase'], mouth_lips:['Mouth & lips','Mund & Lippen'], teeth:['Teeth','Zähne'], marks:['Marks','Male / Narben'], tattoo:['Tattoo','Tätowierung'],
  ...
  expression:['Facial expression','Gesichtsausdruck'], base:['Base expression','Grundausdruck'], smile:['Smile','Lächeln'], emotion:['Emotion','Emotion'], quality:['Expression quality','Ausdruckswirkung'], state:['State','Zustand'], facial_configuration:['Facial configuration','Sichtbare Mimik'], brows:['Brows','Augenbrauen'], mouth:['Mouth','Mund'], combined:['Combined','Kombiniert'],
  ...
  clothing:['Clothing','Kleidung'], garments:['Garments','Kleidungsstücke'], underwear:['Underwear','Unterwäsche'], sleepwear:['Sleepwear','Nachtwäsche'], top:['Tops','Oberteile'], bottom:['Bottoms','Unterteile'], one_piece:['One-piece garments','Einteiler'], outerwear:['Outerwear','Oberbekleidung'], formal:['Formal garments','Formelle Kleidung'], work_protective:['Work & protective clothing','Arbeits- & Schutzkleidung'], swimwear:['Swimwear','Badebekleidung'], hosiery:['Hosiery','Strumpfwaren'], footwear:['Footwear','Schuhe'], accessories:['Clothing accessories','Kleidungsaccessoires'],
  location:['Location','Ort'], indoor:['Indoor','Innenraum'], outdoor:['Outdoor','Außenbereich'], home:['Home','Wohnbereich'], hospitality:['Hospitality','Gastronomie'], education:['Education','Bildung'], nature:['Nature','Natur'], special:['Special','Besondere Orte'], environment:['Environment','Umgebung'], atmosphere:['Atmosphere','Atmosphäre'], interaction:['Interaction','Interaktion'], person_to_person:['Person to person','Person zu Person'], affection:['Affection','Zuneigung'], social:['Social','Sozial'], activity:['Activity','Aktivität'],
  weather_time:['Weather & time','Wetter & Tageszeit'], background:['Background','Hintergrund'], mood:['Mood','Stimmung'], focus_depth_of_field:['Focus & depth of field','Fokus & Schärfentiefe'], shot_style:['Shot style','Aufnahmestil'], style_medium:['Style & medium','Stil & Medium'], realism:['Realism','Realismus'], color_rendering:['Color rendering','Farbwiedergabe'], palette:['Palette','Farbpalette'], temperature:['Color temperature','Farbtemperatur'], contrast:['Contrast','Kontrast'], lens:['Lens effects','Objektiveffekte'], motion:['Motion','Bewegung'],
