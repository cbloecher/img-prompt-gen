...
Offene Aufgaben werden als GitHub-Issues geführt. Details und Begründungen siehe außerdem [Recherche bestehender Projekte](docs/research-existing-projects.md), [Datenmodell](docs/data-model.md), [Person-Taxonomie-Review](docs/person-taxonomy-review.md) und [Safety](docs/safety.md).
...
- [#17 Person-Taxonomie konsolidieren](https://github.com/cbloecher/img-prompt-gen/issues/17)
